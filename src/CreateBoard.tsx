    ...
    return (
        ...
        <span className='WelcomeHeader'>Create Game</span>
            <div className='WelcomeFields'>
                ...
                <span className='WelcomeSpan'>Wrapfield</span><label><input type="checkbox" data-value={boardSettings.wrapfield} onChange={e => HandleWrapfieldChange(e.target.checked)}/><img className='WelcomeCheckbox' alt={boardSettings.wrapfield ? "Wrapfield selected" : "Wrapfield not selected"} src={boardSettings.wrapfield ? "Checkbox-Checked.svg" : "Checkbox-Unchecked.svg"}/></label>
                <span className='WelcomeSpan'>Hint</span><label><input type="checkbox" data-value={boardSettings.hint} onChange={e => HandleHintChange(e.target.checked)}/><img className='WelcomeCheckbox' alt={boardSettings.hint ? "Hint selected" : "Hint not selected"} src={boardSettings.hint ? "Checkbox-Checked.svg" : "Checkbox-Unchecked.svg"}/></label>
            </div>
